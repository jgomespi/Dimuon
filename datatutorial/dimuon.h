...
public :
   ...
   virtual void     FitPeak(TString hist_name);
   virtual void     FillHisto(TH1F* hist, Double_t pT_cut=0.);
   virtual void     SaveHisto(TH1F* hist, Int_t log = 0);
   virtual void     SelectPeak(Double_t pT_cut=0.);
   //virtual void     PtEta(Double_t pT_cut=0.);
